...
public class lab2 {
        ...
        public static void main(String[] args){
            ...
            try{
                    ...
                    while(scanner.hasNextLine()){
                        ...
                        String lineFinal = getInstruction(line0, labelDict, lineCount);
        ...
        public static String getInstruction(String line, Dictionary labelDict, int lineCount){
                ...
                //check if comment
                    ...
                    if(tokenList[x].equals("add")){
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && getRegister(tokenList[x+3]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "100000";
                        }else{
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && getRegister(tokenList[x+3]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "100100";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && getRegister(tokenList[x+3]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "100101";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && isImmediate(tokenList[x+3]) != false){
                            return output = "001000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+1]) + " " + decimaltoImm(tokenList[x+3]);
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && isImmediate(tokenList[x+3]) != false){
                            return output = "000000" + " " + "00000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+1]) + " " + decimaltoSham(tokenList[x+3]) + " " + "000000";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && getRegister(tokenList[x+3]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "100010";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && getRegister(tokenList[x+3]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+2]) + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "101010";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && labelDict.get(tokenList[x+3]) != null){
                            return output = "000100" + " " + getRegister(tokenList[x+1]) + " " + getRegister(tokenList[x+2]) + " " + branchAddress(((Integer)labelDict.get(tokenList[x+3])) - (lineCount + 1));
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null && getRegister(tokenList[x+2]) != null && labelDict.get(tokenList[x+3]) != null){
                            ...
                            return output = "000101" + " " + getRegister(tokenList[x+1]) + " " + getRegister(tokenList[x+2]) + " " + branchAddress(((Integer)labelDict.get(tokenList[x+3])) - (lineCount + 1));
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+3]) != null && getRegister(tokenList[x+1]) != null && isImmediate(tokenList[x+2]) != false){
                            return output = "100011" + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + decimaltoImm(tokenList[x+2]);
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+3]) != null && getRegister(tokenList[x+1]) != null && isImmediate(tokenList[x+2]) != false){
                            return output = "101011" + " " + getRegister(tokenList[x+3]) + " " + getRegister(tokenList[x+1]) + " " + decimaltoImm(tokenList[x+2]);
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(labelDict.get(tokenList[x+1]) != null){
                            return output = "000010" + " "  + decimaltoAddress((Integer)labelDict.get(tokenList[x+1]));
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(getRegister(tokenList[x+1]) != null){
                            return output = "000000" + " " + getRegister(tokenList[x+1]) + " " + "00000" + " " + "00000" + " " + "00000" + " " + "001000";
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
                        ...
                        if(labelDict.get(tokenList[x+1]) != null) {
                            return output = "000011" + " "  + decimaltoAddress((Integer)labelDict.get(tokenList[x+1]));
                        }else{
                            System.out.println("invalid syntax for instruction: " + tokenList[x]);
                            System.exit(0);
                        }
